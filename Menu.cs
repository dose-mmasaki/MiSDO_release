...
namespace DoNuTS_dotNET4_0
{
    public partial class Menu : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string str_to_donuts = @".\Resources\main_DoNuTS.py";

            string startDoNuTS = py37 + " " + str_to_donuts;
        ...
        private void RunChuRROs()
        {
            ...
            {
                string str_to_churros = @".\Resources\main_ChuRROs.py";
                // 引数を代入
                string lang = "--lang " + frm.language;

                string startChuRRos = py37 + " " + str_to_churros + " " + lang;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string str_to_show = @".\Resources\main_show_low_data.py";
        ...
        {
            string str_to_out_csv = @".\Resources\main_out_csv.py";

            try
            {
                string arg = "--sql \"" + sql + "\"";
                string start_out_csv = "call " + py37 + " " + str_to_out_csv + " " + arg;
