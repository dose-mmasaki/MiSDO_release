...
def main(_modality, rdsr_files_dict, modality_files_dict, new_data_cnt, duplicate_data_cnt):
    rdsr_data = []
...
if __name__ == '__main__':
    ...
    for _modality in rdsr_files_dict:
        ...
        rdsr_data_generator = main(
            _modality, rdsr_files_dict, modality_files_dict, new_data_cnt, duplicate_data_cnt)
        for each_modality_rdsr_data in rdsr_data_generator:
            print(" each_modality_rdsr_data : {}".format(
                sys.getsizeof(each_modality_rdsr_data)))
            for each_rdsr_data in each_modality_rdsr_data:
