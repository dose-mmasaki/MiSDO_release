...
def main():
    ...
    if int(len(dicom_files)) == 0:
        ...
        print("Found RDSR files : {}".format(funcs.show_len_identified(rdsr_files_dict)))
        print("Fround the other dicom : {}".format(funcs.show_len_identified(modality_files_dict)))
    ...
    if num_rdsr == 0:
        ...
        messagebox.showerror('ERROR', 'Cannot find a file that can be processed．')
        sys.exit()
    ...
    for _modality,p in zip(rdsr_files_dict,rdsr_path_dict):
        ...
        if _modality != 'Unknown':
            ...
            print("{} : New {} records, duplicated {} records".format(_modality, new_data_cnt, duplicate_data_cnt))
